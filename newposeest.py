...
def check_pose(current_angles, pose_data, pose_name):
    """ Check if the current angles match the reference pose data. """
    ...
    tolerance = 10  # degrees for angles
    ...
    if angle_diff_right < tolerance and angle_diff_left < tolerance:
...
def main():
    ...
    while True:
        ...
        if results.pose_landmarks:
            ...
            posture_status, color = check_pose(angles, pose_data, selected_pose)
